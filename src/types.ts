...
export type ViewState = 'landing' | 'discover' | 'farmer' | 'inventory' | 'vending' | 'about' | 'support' | 'favorites' | 'admin' | 'admin_prospects' | 'register_farm' | 'verification_pending' | 'my_farm' | 'pricing';
