...
import { Check, Zap, Store, HelpCircle } from 'lucide-react';
...
export const SubscriptionSection: React.FC<SubscriptionSectionProps> = ({ farm, onUpdate, showToast }) => {
    ...
    return (
        <div className="bg-white/90 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-white/20 mb-8 relative overflow-hidden">
            {/* Trial Banner */}
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8 pt-4">
                    <h2 className="text-2xl font-black text-emerald-900 mb-2">Kies je Groeiplan</h2>
                    <p className="text-slate-600 font-medium max-w-xl mx-auto">Geniet nu van de gratis testfase. Kies alvast je plan voor later om naadloos door te groeien.</p>
