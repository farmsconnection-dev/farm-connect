...
export const DICTIONARY: TranslationDictionary = {
  ...
  about_chain_desc: { nl: "Minder transport, minder verpakking, en een smaak die je in de supermarkt niet vindt.", fr: "Moins de transport, moins d'emballage, et un goût que vous ne trouvez pas au supermarché.", en: "Less transport, less packaging, and a taste you won't find in the supermarket.", de: "Weniger Transport, weniger Verpackung und ein Geschmack, den man im Supermarkt nicht findet." },
  about_banner_title: { nl: "Samen bouwen we aan een lokale toekomst.", fr: "Ensemble, construisons un avenir local.", en: "Together we build a local future.", de: "Gemeinsam bauen wir eine lokale Zukunft auf." },
  about_banner_text: { nl: "Bedankt dat je deel uitmaakt van Farm Connect. Elk product dat je hier koopt, is een stem voor een duurzame landbouw.", fr: "Merci de faire partie de Farm Connect. Chaque produit que vous achetez ici est un vote pour une agriculture durable.", en: "Thank you for being part of Farm Connect. Every product you buy is a vote for sustainable agriculture.", de: "Danke, dass Sie Teil von Farm Connect sind. Jedes Produkt, das Sie kaufen, ist eine Stimme für eine nachhaltige Landwirtschaft." },
