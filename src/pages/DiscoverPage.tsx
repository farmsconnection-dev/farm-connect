...
import { Search, X, List as ListIcon, Map as MapIcon, Clock, Navigation, Heart, MapPin, Leaf, AlertTriangle, Loader2, Banknote, QrCode, CheckCircle2, ChevronDown, Filter } from 'lucide-react';
...
export const DiscoverPage: React.FC<DiscoverPageProps> = ({
    ...
    const [isPrimaryFiltersOpen, setIsPrimaryFiltersOpen] = useState(false);
                            ...
                            {isPrimaryFiltersOpen && (
                                <>
                                    ...
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1 }}
                                        exit={{ opacity: 0 }}
                                        onClick={() => setIsPrimaryFiltersOpen(false)}
                                    ...
                                    <motion.div
                                        ...
                                        className="fixed left-4 sm:left-[60px] top-[200px] w-64 sm:w-56 bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/20 p-3 sm:p-2 z-[10000] space-y-1"
                                    >
                                        <motion.button
                                            whileHover={{ scale: 1.02 }}
                                            whileTap={{ scale: 0.98 }}
