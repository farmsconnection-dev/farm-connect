    ...
    return (
        <motion.div key="vending" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, x: -20 }} className="h-screen w-full flex flex-col pt-32 px-4 sm:px-8 pb-10 max-w-4xl mx-auto overflow-y-auto scrollbar-hide">
            <div className="mb-8 flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight drop-shadow-md">{t('vending_title')}</h1>
                    <p className="text-emerald-100/60 font-bold uppercase tracking-widest text-[10px]">{t('vending_subtitle')}</p>
                </div>
            </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder={t('vending_location_placeholder')}
                            />
                        </div>
            ...
            {isActive && (
                <div className="bg-white/80 backdrop-blur-xl p-8 rounded-apple shadow-xl border border-white/20">
                    <h3 className="text-xl font-bold text-forest mb-6 flex items-center gap-2">📦 {t('vending_products_title')}</h3>
                    <p className="text-sm text-slate-500 mb-4">{t('vending_products_text')}</p>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        ...
                        {myFarm.products.length === 0 && (
                            <div className="text-center text-slate-400 py-4 italic text-sm">{t('vending_no_products')}</div>
                        )}
                    </div>
                </div>
            )}
